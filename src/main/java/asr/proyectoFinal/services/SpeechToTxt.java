 ...
 */
@MultipartConfig
@WebServlet(urlPatterns = {"/toTxt"})
public class SpeechToTxt extends HttpServlet {

	private static final long serialVersionUID = 5L;
	
	public final static String USER_NAME = "7994c248-7825-467f-a14a-621f4bd3fd61";
	public final static String PASSWORD = "by0M1oqKzWmp";

protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
  {
    SpeechToText service = new SpeechToText(USER_NAME, PASSWORD);
